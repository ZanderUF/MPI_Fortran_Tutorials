...
Subroutine Create_Row_Data_Type(new_data_type, start_x, end_x, start_y, end_y) 
    ...
    Integer, intent(in) :: end_x, start_x, end_y, start_y
    
    !***Local variables
    Integer :: ierr
    
    !***Create MPI data type to get rows of the 2d matrix
    Call MPI_Type_Vector(end_x - start_x + 1, 1, end_y - start_y + 1, MPI_Double_Precision, &
                         new_data_type, ierr)
